          ...
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link href={"/"}>
              <div className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 cursor-pointer">
                <Image src={NavLogo} alt=".." width={170} height={15} />
                {/* <span className="ml-3 text-xl"></span> */}
              </div>
            </Link>
            <p className="mt-2 px-4 text-sm text-gray-500">
              Flex your wear everyday!!
            </p>
          </div>
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link legacyBehavior href={"/pants"}>
                    <a className="text-gray-500 hover:text-gray-800">Pants</a>
                  </Link>
                </li>
              </nav>
            </div>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">
              © 2024 kharidari.com — All Rights Reserved
